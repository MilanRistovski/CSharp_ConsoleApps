...
namespace atm
{
    class MoneyBankATM : ILogin, IBalance, IDeposit, IWithdrawal, IThirdPartyTransfer, ITransaction
    {
        ...
        private static void LockAccount()
        {
            ...
            Console.WriteLine("Thank you for using Milan Bank. ");
            Console.ReadKey();
            System.Environment.Exit(1);
        }
        ...
        public void ViewTransaction(BankAccount bankAccount)
        {
            ...
            else 
            {
                foreach (var tran in _listOfTransactions) {
                    Console.WriteLine("Type:{0}", tran.TransactionType);
                    Console.WriteLine("From:{0}", tran.BankAccountNoFrom);
                    Console.WriteLine("To: {0}", tran.BankAccountNoTo);
                    Console.WriteLine("Amount: {0}", tran.TransactionAmount);  
                }
            }
        }
